...
def sign_up():
    ...
    if form.validate_on_submit():
        ...
        form = WeeklySignUp(id=num_of_signups + 1,
                            week_of_meeting_name=form.week_meet.data,
                            student_id=current_user.student_id,
                            primary_time_preference=form.prime_time_id.data,
                            secondary_time_preference=form.sec_time_id.data,
                            # primary_networking_goal_id=form.prime_networking_goal_id.data,
