...
class ProfileForm(FlaskForm):
    ...
    matched_class_list = [x.matched_class_num for x in MatchedClass.query.all()]  # Gets the list of classes from the DB
...
# Next week meet form
class NextWeek(FlaskForm):
    matching = SelectField(  # Networking Goal
        'I would like to be matched by: ',
        [DataRequired()],
        choices=[x.networking_goal_name for x in NetworkingGoal.query.all()]
